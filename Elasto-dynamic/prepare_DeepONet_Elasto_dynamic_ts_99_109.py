...
if __name__ == "__main__":
    ...
    foldername = 'prepare_DeepONet_Elasto_dynamic_square_square_99_109'
    ...
    U1 = npr.loadtxt('U1 ts = 101.txt')
    V1 = npr.loadtxt('V1 ts = 101.txt')
    U1_new = npr.loadtxt('U1 ts = 102.txt')
    V1_new = npr.loadtxt('V1 ts = 102.txt')
    vx = npr.loadtxt('vx ts = 101.txt')/100 # for nomalization velocity should be divided by 100 (as input for CNN)
    vy = npr.loadtxt('vy ts = 101.txt')/100 # for nomalization velocity should be divided by 100 (as input for CNN)
