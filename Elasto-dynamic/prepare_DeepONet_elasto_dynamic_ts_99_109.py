...
def BranchNet_dil(params, x):
    ...
    x (array): Input tensor of shape (batch_size, 4*ms) where ms = nx1 * nx1
...
foldername = 'prepare_DeepONet_disk_dynamic_square_square_99_109'
...
if __name__ == "__main__":
    ...
    vx = npr.loadtxt('vx ts = 101.txt')/100
    vy = npr.loadtxt('vy ts = 101.txt')/100
