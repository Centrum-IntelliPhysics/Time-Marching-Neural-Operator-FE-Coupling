...
foldername = '0113_prepare_DeepONet_disk_dynamic_square_square_119_129'
...
if __name__ == "__main__":
    ...
    U1 = npr.loadtxt('U1 ts = 127.txt')
    V1 = npr.loadtxt('V1 ts = 127.txt')
    U1_new = npr.loadtxt('U1 ts = 128.txt')
    V1_new = npr.loadtxt('V1 ts = 128.txt')
    vx = npr.loadtxt('vx ts = 127.txt')/100
    vy = npr.loadtxt('vy ts = 127.txt')/100
